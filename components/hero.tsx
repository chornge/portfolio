...
export default function Hero() {
  ...
  const appsDelivered = 3 + experiences.length
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-12">
            <TextGenerateEffect
              words={`${yearsOfExperience} years of experience developing high-quality Android applications. Specialized in Kotlin, Jetpack Compose, Clean Architecture, and building scalable mobile solutions.`}
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <motion.a
              href="/resume"
              download="Christian_Mbaba_Resume.pdf"
              ...
              whileHover={prefersReducedMotion ? {} : { scale: 1.05, y: -2 }}
              whileTap={prefersReducedMotion ? {} : { scale: 0.95 }}
              onClick={() => Analytics.resumeDownloaded("hero")}
            >
              Download Resume
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            {[
              ...
              { value: `${appsDelivered}+`, label: "Apps Delivered" },
