  ...
  const skillCategories = [
    {
      title: "Android Core",
      icon: Smartphone,
      skills: ["Kotlin", "Java", "Jetpack Compose", "Android SDK", "AndroidTV/FireTV", "MVVM/MVI/MVP"],
      color: "from-green-500 to-emerald-500",
    },
    {
      title: "Tools",
      icon: Zap,
      skills: ["Android Studio", "Gradle", "Git", "GitHub Actions", "CircleCI", "Fastlane"],
      color: "from-blue-500 to-cyan-500",
    },
    {
      title: "Libraries & APIs",
      icon: Code2,
      skills: ["Coroutines & Flows", "Dagger/Hilt", "Retrofit/Ktor", "Room/Realm", "ExoPlayer", "RxJava"],
      color: "from-purple-500 to-pink-500",
    },
    {
      title: "Testing",
      icon: Database,
      skills: ["JUnit", "Espresso", "Mockk/Mockito", "WCAG Accessibility", "TDD", "BrowserStack"],
